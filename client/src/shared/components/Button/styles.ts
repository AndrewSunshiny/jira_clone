...
const filledStyles = (props: { $color?: keyof typeof color; disabled?: boolean }) => css`
  color: #fff;
  ${!!props.$color
  && css`
...
const hollowStyles = (props: { disabled?: boolean }) => css`
...
export const StyledSpinnerComponent = styled(Spinner)<ComponentProps<typeof Spinner>>`
  position: relative;
  right: 8px;
  display: inline-block;
  vertical-align: middle;
